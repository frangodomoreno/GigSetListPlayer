	...
	public void createUI(Bundle savedInstanceState) {
		...
		mDocView = new MuPDFReaderView(this) {
			...
			protected void onTapMainDocArea() {				
				// 20151203 Monasys Force finish when tapped for gig setlist player integration
				finish() ;
...
//				}
		...
		if (savedInstanceState == null || !savedInstanceState.getBoolean("ButtonsHidden", false)){			
			// 20151203 Monasys Force hide of menu for gig setlist player integration
			hideButtons();
			// Original Code
			//showButtons();
		}
